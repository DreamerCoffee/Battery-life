document.getElementById('calculateBtn').addEventListener('click', function() {
    ...
    var designCapacity = parseFloat(document.getElementById('designCapacity').value);
    var fullChargeCapacity = parseFloat(document.getElementById('fullChargeCapacity').value);
    
    if (!isNaN(designCapacity) && !isNaN(fullChargeCapacity) && fullChargeCapacity !== 0) {
